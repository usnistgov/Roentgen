...
abstract public class NamedMultivariateJacobianFunction
   ...
   /***
    * Unique object tags identifying each of the random variable arguments to
    * the functions
    */
   ...
   public NamedMultivariateJacobianFunction(final List<? extends Object> inputTags, final List<? extends Object> outputTags) {
   ...
   /**
    * Returns the index of the output variable identified by the specified
    * Object
    *
    * @param tag
    * @return int Index or -1 for not found.
   ...
   /**
    * Converts a HashMap&lt;Object, Double&gt; to an array ordered according to
    * the names in getVariableNames().
    *
    * @param point
    * @return RealVector
    */
   ...
   /**
    * Builds a map containing the output variable names and the values to
    * associate with them as specified in point.
    *
    * @param point The values to assign to the variables in the same order as
    *           the variable tags.
    ...
    * </p>
    *
    * @param argTags The tags associated with <code>args</code>. A superset of
    *           the tags in <code>this.getInputTags()</code>.
    ...
    * then checks the output RealVector and RealMatrix to ensure that they are
    * all the correct dimensions.
    * </p>
    *
    * @param x
    * @return Pair&lt;{@link RealVector}, {@link RealMatrix}&gt; As from a call
    *         to <code>value(x)</code>.
    */
   ...
   public static NamedMultivariateJacobianFunction normalize(final List<? extends Object> inTags, final List<? extends Object> outTags) {
   ...
   public static NamedMultivariateJacobianFunction sum(final List<? extends Object> inTags, final Object outTag) {
      return new NamedMultivariateJacobianFunction(inTags, Collections.singletonList(outTag)) {
         ...
         public Pair<RealVector, RealMatrix> value(final RealVector point) {
            ...
            return Pair.create(MatrixUtils.createRealVector(new double[] {
               sum
   ...
   public static NamedMultivariateJacobianFunction linear(final List<? extends Object> inTags, final RealVector coeffs, final Object outTag) {
      return new NamedMultivariateJacobianFunction(inTags, Collections.singletonList(outTag)) {
         ...
         public Pair<RealVector, RealMatrix> value(final RealVector point) {
            ...
            final RealVector vals = MatrixUtils.createRealVector(new double[] {
               dot
            });
   ...
   public String toHTML(final Mode mode) {
      switch(mode) {
         ...
         case VERBOSE: {
            ...
            res.addRow(Table.td(outs.toHTML(Mode.NORMAL)), Table.td(" = F("), Table.td(args.toHTML(Mode.NORMAL)), Table.td(")"));
