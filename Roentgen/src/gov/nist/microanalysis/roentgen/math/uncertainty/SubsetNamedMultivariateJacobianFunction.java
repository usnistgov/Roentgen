...
/**
 * <p>
 * Extracts a subset of the rows and columns associated with the provided base
 * {@link NamedMultivariateJacobianFunction}. Use with care as this function
 * will evaluate the base {@link NamedMultivariateJacobianFunction} each time
 * the value(...) method is called.
 * <p>
 *
 * <p>
 * If you want to avoid the cost of repeated evaluations, it is possible to pass
 * a {@link NamedMultivariateJacobian} (a
 * {@link NamedMultivariateJacobianFunction} evaluated at a specific point) in
 * place of the {@link NamedMultivariateJacobianFunction} so long as the point
 * of evaluation doesn't change.
 * </p>
 *
 *
 * @author nicho
...
public class SubsetNamedMultivariateJacobianFunction extends NamedMultivariateJacobianFunction {
	...
	public SubsetNamedMultivariateJacobianFunction( //
		...
		mBase = nmvjf;
		{
			final List<? extends Object> inputs = getInputTags();
		...
		{
			final List<? extends Object> outputs = getInputTags();
