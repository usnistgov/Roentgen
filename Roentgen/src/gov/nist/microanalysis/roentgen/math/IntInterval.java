...
public class IntInterval
   ...
   /**
    * Does this Interval intersect the Interval r2? An interval intersects if
    * even one point touches.
    *
    * @param r2
    * @return boolean
    */
   ...
   /**
    * Returns the Interval which fully contains r1 and r2. r1 and r2 don't need
    * to intersect.
    *
   ...
   /**
    * Returns the Interval which fully contains r1 and val. r1 and val don't
    * need to intersect.
    *
   ...
   /**
    * Adds r to the set of Range objects. If r intersects a Range in rs then the
    * r and the intersecting Range object are combined into a single Range.
    *
    * @param rs
