...
public class TestEDSFittingFilter {
	...
	public void testGaussianExtent() throws Exception {
		...
		final LineshapeCalibration ls = new LineshapeCalibration.Gaussian(130.0,
		...
		final IDoubleAsColor colorize = new MathUtilities.PositiveNegativeAsColor(-ext, Color.RED, ext, Color.GREEN,
				Color.YELLOW, 1.0);
	...
	@Test
	public void testTophatExtent() throws Exception {
		final EnergyCalibration ec = EnergyCalibration.Linear(0.0, 10.0, 2048);
		final LineshapeCalibration ls = new LineshapeCalibration.Gaussian(130.0,
				LineshapeCalibration.Gaussian.SDD_EV_PER_EH);
