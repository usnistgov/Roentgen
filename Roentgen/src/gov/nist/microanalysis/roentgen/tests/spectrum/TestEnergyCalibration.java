...
public class TestEnergyCalibration {
   ...
   public void testQuadratic() {
      ...
      assertEquals(q.equals(new Polynomial(new double[] {
         -100.0,
         10.0,
         1.0e-6
      }, 2048)), true);
   ...
   public void testPolynomial() {
      final Polynomial q = new Polynomial(new double[] {
         -100.0,
         10.0,
         1.0e-6,
         -1.0e-9
   ...
   public void testQuadraticInSqrt() {
      ...
      assertEquals(q.averageEnergyForChannel(0), 0.5 * (e(10.0, 0.01, -100.0, 0) + e(10.0, 0.01, -100.0, 1.0)), 1.0e-5);
      assertEquals(q.averageEnergyForChannel(1000), 0.5
            * (e(10.0, 0.01, -100.0, 1000) + e(10.0, 0.01, -100.0, 1001.0)), 1.0e-4);
      assertEquals(q.channelIndex(10005.0), 1010);
      assertEquals(q.channelIndex(0.0), 9);
      assertEquals(q.channelIndex(10.0), 10);
