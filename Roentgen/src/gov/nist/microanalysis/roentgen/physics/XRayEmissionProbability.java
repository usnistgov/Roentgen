...
public class XRayEmissionProbability //
	 ...
	 * produced when this shell is ionized. The weights are normalized to the most
	 * probable being a weight of unity.
	 *
	 * @param direct true to only include those transitions directly from this shell
