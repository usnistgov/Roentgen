...
public class AtomicShell
   ...
   private static void addExtra(final Map<Element, TreeMap<Shell, AtomicShell>> res, final Element elm, final Shell sh, final double energy) {
   ...
   /**
    * <p>
    * There are a number of element's for whom there are no edge energies for
    * close to valence shells in the Chantler database. For these, I've used the
    * numbers in:
    * </p>
    * <p>
    ...
    * </p>
    * <p>
    * The values are all small (near valence) so the exact value isn't critical
    * and these would seem to be close enough for our purposes.
    * </p>
    *
    * @param res
    */
   ...
   /**
    * Returns the AtomicShell object representing the specific Element and Shell
    * or null if none exists. Use this instead of the private AtomicShell
    * constructor.
    *
    * @param elm Element
    * @param shell Shell
   ...
   /**
    * Returns the AtomicShell for the specified Element that is the closest in
    * edge energy below the specified ionizationE.
    *
    * @param elm
    * @param ionizationE
    * @return AtomicShell
   ...
   /**
    * Returns a list of AtomicShell in fam below energy eMax (sorted high to
    * low)
    *
