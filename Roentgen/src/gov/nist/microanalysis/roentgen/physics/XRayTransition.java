...
public enum XRayTransition implements Comparable<XRayTransition> {
	...
	public final static XRayTransition[] K_ALPHA = new XRayTransition[] { KL3, KL2, KL1 };

	public final static XRayTransition[] K_BETA = new XRayTransition[] { KM3, KN3, KN2, KM2, KN5, KN4, KM5, KM4 };

	public final static XRayTransition[] K_OTHER = new XRayTransition[] { KO2, KO3, KO4, KO5, KP2, KP3 };

	public final static XRayTransition[] K_ALL = combine(K_ALPHA, K_BETA, K_OTHER);

	public final static XRayTransition[] L_ALPHA = new XRayTransition[] { L3M5, L3M4 };

	public final static XRayTransition[] L_BETA = new XRayTransition[] { L3N4, L3N5, L3O4, L3N1, L3O1, L2M4, L2M3, L1M4,
			L1M3, L1M2, L1M5 };

	public final static XRayTransition[] L_GAMMA = new XRayTransition[] { L2N4, L2N1, L2O4, L2O1, L1N2, L1N5, L1N3,
			L1O3, L1O5, L1O2 };

	public final static XRayTransition[] L_OTHER = new XRayTransition[] { L3N2, L3N3, L3O2, L3O3, L3P1, L3O5, L3M1,
			L3M3, L3M2, L3N6, L3N7, L3O6, L3O7, L2M2, L2M5, L2N2, L2N3, L2N5, L2O2, L2O3, L2P2, L2M1, L2N6, L2N7, L1M1,
			L1N1, L1N4, L1O1, L1O4, L2O6, L2P1, L2Q1, L3Q1, L1P2, L1P3, L2P3, L3P2, L3P3 };

	public static final XRayTransition[] L_ALL = combine(L_ALPHA, L_BETA, L_GAMMA, L_OTHER);

	public static final XRayTransition[] M_ALPHA = new XRayTransition[] { M5N7, M5N6 };

	public static final XRayTransition[] M_GAMMA = new XRayTransition[] { M3N5 };

	public static final XRayTransition[] M_ZETA = new XRayTransition[] { M4N2, M5N3 };

	public static final XRayTransition[] M_OTHER = new XRayTransition[] { M1N2, M1N3, M1O2, M1O3, M2M4, M2N1, M2N4,
			M2O1, M2O4, M2Q1, M3M4, M3M5, M3N1, M3N4, M3O1, M3O4, M3O5, M3Q1, M4N3, M4O2, M4O3, M4N6, M4O6, M4P2, M4P3,
			M5O3, M2P1, M3P1, M1P2, M1P3, M5P3, M5O6, M5O7 };

	public static final XRayTransition[] M_ALL = combine(M_ALPHA, M_GAMMA, M_ZETA, M_OTHER);

	public static final XRayTransition[] N_ALL = new XRayTransition[] { N1O2, N1O3, N2O1, N2O4, N1P2, N1P3, N2P1, N2Q1,
			N3O1, N3O4, N3O5, N3P1, N3Q1, N4O2, N4O3, N4N6, N4P2, N4P3, N4O6, N5N6, N5O3, N5O7, N5P3, N5O6, N6O4, N6O5,
			N7O5 };

	public static final XRayTransition[] O_ALL = new XRayTransition[] { O1P2, O1P3, O2P1, O2Q1, O3P1, O3Q1 };
	...
	private XRayTransition(final Shell inner, final Shell outer, final String seigbahn) {
		...
		Preconditions.checkArgument(inner.compareTo(outer) < 0,
				"The inner shell must be strictly inside the outer shell.");
		mInner = inner;
		mOuter = outer;
		mSeigbahn = seigbahn;
	}
	...
	public static void main(final String[] args) {
		...
		{
			final ArrayList<XRayTransition> al = new ArrayList<>(
					Arrays.asList(combine(K_ALL, L_ALL, M_ALL, N_ALL, O_ALL)));
			for (final XRayTransition xrt : values())
				al.remove(xrt);
