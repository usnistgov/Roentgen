...
public class AtomFractionToMassFraction //
	...
	public Pair<RealVector, RealMatrix> value(final RealVector point) {
		...
		for (int o1 = 0; o1 < getOutputDimension(); ++o1) {
			...
			final int awt1 = inputIndex(
					MaterialLabel.buildAtomicWeightTag(mft.getMaterial(), mft.getElement()));
			final int aft1 = inputIndex(
					MaterialLabel.buildAtomFractionTag(mft.getMaterial(), mft.getElement()));
			...
			for (int i2 = 0; i2 < getInputDimension(); ++i2) {
				...
				if (inLabel instanceof MaterialLabel.AtomFraction) {
					...
					final int awt2 = inputIndex(MaterialLabel.buildAtomicWeightTag(aft.getMaterial(), aft.getElement()));
					...
					AtomFraction aft2 = MaterialLabel.buildAtomFractionTag(awt.getMaterial(),awt.getElement());
