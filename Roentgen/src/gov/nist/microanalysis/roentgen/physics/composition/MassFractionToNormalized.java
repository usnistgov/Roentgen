...
/**
 * Used on composition data to convert mass fractions into normalized mass
 * fractions.
 *
 * @author nicholas
 *
...
public class MassFractionToNormalized //
	...
	public Pair<RealVector, RealMatrix> value(final RealVector point) {
		...
		for (int i1 = 0; i1 < getOutputDimension(); ++i1) {
			...
			final MaterialLabel.MassFraction mft = MaterialLabel.buildMassFractionTag(nmft.getMaterial(),
					nmft.getElement());
