...
public enum Shell implements Comparable<Shell> {
   ...
   public static final Shell[] K_FAMILY = new Shell[] {
      Shell.K
   };

   public static final Shell[] L_FAMILY = new Shell[] {
      Shell.L1,
      Shell.L2,
      Shell.L3
   };

   public static final Shell[] M_FAMILY = new Shell[] {
      Shell.M1,
      Shell.M2,
      Shell.M3,
      Shell.M4,
   ...
   public static final Shell[] N_FAMILY = new Shell[] {
      Shell.N1,
      Shell.N2,
      Shell.N3,
      Shell.N4,
   ...
   public static final Shell[] O_FAMILY = new Shell[] {
      Shell.O1,
      Shell.O2,
      Shell.O3,
      Shell.O4,
   ...
   public static final Shell[] P_FAMILY = new Shell[] {
      Shell.P1,
      Shell.P2,
      Shell.P3,
      Shell.P4,
   ...
   /**
    * Returns the next shell in the same family as this (or null)
    * L1.nextInFamily() -> L2 L3.nextInFamily() -> null
    *
    * @return Shell
    */
   ...
   /**
    * Returns the next shell in the same family as this (or null)
    * L1.nextInFamily() -> null L3.nextInFamily() -> L2
    *
    * @return Shell
    */
