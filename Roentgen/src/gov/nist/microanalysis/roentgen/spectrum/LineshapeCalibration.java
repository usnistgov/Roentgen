...
abstract public class LineshapeCalibration {
   ...
   /**
    * Returns the x-ray intensity that would be measured at energy E for an
    * x-ray with energy xRayEnergy.
    *
    * @param xRayEnergy
    * @param e
    * @return double on range (0.0, 1.0)
   ...
   /**
    * For a line centered at xRayEnergy, this function returns the distance
    * until the initial intensity has dropped to 'fraction' of its intial value.
    *
    * @param xRayEnergy
    * @param mode
   ...
   static public class Gaussian
      extends
      LineshapeCalibration {
