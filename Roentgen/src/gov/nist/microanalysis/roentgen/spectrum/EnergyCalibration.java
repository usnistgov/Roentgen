...
abstract public class EnergyCalibration
   ...
   /**
    * Compute the channel for the specified energy where the returned channel
    * may be non-integral.
    *
    * @param ch
    * @param params
   ...
   static public class Polynomial
      ...
      private static final String[] ORDER_NAMES = new String[] {
         "Offset",
         "Linear",
         "Quadratic",
         "Cubic",
   ...
   static public class QuadraticInSqrt
      extends
      EnergyCalibration
      implements
      IToHTML {
