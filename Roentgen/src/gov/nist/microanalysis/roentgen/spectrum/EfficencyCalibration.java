...
public class EfficencyCalibration {
	 ...
	 */
	public EfficencyCalibration(
			final double[] xval, final double[] yval
	) {
		mCalibration = (new SplineInterpolator()).interpolate(xval, yval);
	}

	public static EfficencyCalibration siliconDetector(
			final double thickness, final XRayWindow window
	) {
