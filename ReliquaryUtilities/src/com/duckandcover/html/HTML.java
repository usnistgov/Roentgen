...
public class HTML {
	...
	public static String link(final URI uri, final String html) throws MalformedURLException {
	...
	public static String fontColor(final String html, Color col) {
		return "<font color=\"rgb(" + col.getRed() + "," + col.getGreen() + "," + col.getBlue() + ")\">" + html
				+ "</font>";
	}
	 ...
	 * @throws IOException
	 */
	private static boolean writePNG(final BufferedImage img, final File pngFile) throws IOException {
		pngFile.delete();
		return ImageIO.write(img, "png", pngFile);
	}

	/**
	 * Returns the specified integer as an ordinal string of the form 1st, 2nd, 3rd
	 * etc.
	 *
	 * @param n
	 * @return String in HTML
	 ...
	 */
	public static String asTable(final List<String> colHeaders, final List<String> rowHeaders,
	...
	public static void generateDefaultStyleSheet(final File reportDir, final String cssName) throws IOException {
	 ...
	 */
	public static void toFile(final IToHTML item, final File f, final Mode mode, final String dir) throws IOException {
	...
	/**
	 * Removes all HTML tags and replaces all HTML letter encodings with the unicode
	 * equivalents.
	 *
	 * @param html
	 * @return String
