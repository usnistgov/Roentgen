 ...
 * @version 1.0
 */
public class JWizardDialog<W> extends JDialog {
	/**
	*
	*/
	...
	private void wizInitialize(final Dimension dim) throws Exception {
	...
	public void setExtendedError(final String errorMsg, final String dialogMsg, final String longMsg) {
		...
		jButton_ErrorBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				...
				JErrorDialog.createErrorMessage(JWizardDialog.this, "Extended error message",
						mLongErrorMsg.size() == 1 ? mDialogMsg : mLongErrorMsg.size() + " errors...", sb.toString());
			}
		});
	}
	...
	public void setIcon(final Icon icon) {
		if (icon instanceof ImageIcon) {
			...
			jLabel_Icon
					.setIcon(new ImageIcon(imgIcon.getImage().getScaledInstance(64, 59, Image.SCALE_AREA_AVERAGING)));
		} else
	...
	private void createTop() {
		...
		jPanel_Main.add(header, CC.xy(2, 2));
		{
			final JPanel msgPanel = new JPanel(
					new FormLayout("5dlu, right:40dlu, 5dlu, 260dlu, 5dlu, pref, 5dlu", "pref"));
