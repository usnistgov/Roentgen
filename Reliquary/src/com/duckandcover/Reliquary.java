...
public class Reliquary {
	...
	public static boolean versionHigherThanOrEqualTo(
			final int[] current, final int[] test
	) {
	...
	public static boolean argExists(
			final String[] args, final String argItem
	) {
	...
	public static void main(
		...
		try {
			...
			final int[] testVer = new int[] { 1, 8, 0, 144 };
			if ((osName.endsWith("10") && (!versionHigherThanOrEqualTo(getJavaVersion(), testVer)))
					|| argExists(args, "-nimbus"))
